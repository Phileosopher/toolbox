...
[craftcms/awesome: A collection of awesome Craft CMS plugins, articles, resources and shiny things.](https://github.com/craftcms/awesome)
...
[GitHub - dustinspecker/awesome-flow: A list of awesome Flow integrations, tools, tutorials, etc.](https://github.com/dustinspecker/awesome-flow)
...
[Scripts Organizer](https://dplugins.com/products/scripts-organizer/)
...
[Ahish9009/design-resources: Resources I like to use while designing](https://github.com/Ahish9009/design-resources)

[ann-kilzer/free-web-design-resources: Free web design resources for developers, startups, UI / UX designers](https://github.com/ann-kilzer/free-web-design-resources)

[GitHub - duncangraham/design-resources: A collection of high-value design resources](https://github.com/duncangraham/design-resources)

[GitHub - reinaldosimoes/design-resources: Curated free design resources for all projects.](https://github.com/reinaldosimoes/design-resources)

[GitHub - theepiccode/Awesome-Design-Resources: An awesome collection of curated design resources(Books, Tutorials, Blogs, Podcasts , ...)](https://github.com/theepiccode/Awesome-Design-Resources)

[GitHub - ypereirareis/material-design-resources: A list of material design resources (Frameworks, documentation, libraries,....). VueJs, ReactJs, AngularJs, Magento, Jekyll, Polymer, Ember](https://github.com/ypereirareis/material-design-resources)

[GitHub - Granze/awesome-polymer: A collection of awesome Polymer resources.](https://github.com/Granze/awesome-polymer)

[GitHub - merhanmostafa47/Useful-Resources: You can find some resources that helps you as a web developer or UI&UX designer](https://github.com/merhanmostafa47/Useful-Resources)

[typeset](https://typeset.lllllllllllllllll.com/)
HTML Typography Pre-Processor

[Show HN: Randomly create beautiful website layouts | Hacker News](https://news.ycombinator.com/item?id=29349079)
[Start a new project with one million layouts](https://shuffle.dev/setup)
...
## domains - blockchain and web3 domains tools
...
## domains - DNS - DNS database tools
...
## domains - DNS - name generator tools
...
[SmartyNames.com Business Name Generator with AI](https://smartynames.com/)
Free Creative Domain Name Search By AI Robots. Finding A Creative And Unique Domain That Is Still Available Is Easy With SmartyNames.com - Tell Us What You Do, And Our Robots Will Find The Domain That Is Just Right For You. Company Name Generator In One Click.

[Xona.com - Domain Hacks](https://xona.com/domainhacks/)
[Domain Hack Generator The last tool you will ever need!](https://domainhacks.info/)

## domains - DNS propagation check tools
...
## domains - DNS protocol tools

[BIND](https://gitlab.isc.org/isc-projects/bind9)
Portable DNS Protocol

## domains - DNS - registrar tools
...
## domains - DNS server search tools
...
## domains - domain server tools

[Web landing page | Regtons.com](https://regtons.com/en)

## domains - expired domains tools
...
## domains - search - marketplace tools
...
[HTTP Toolkit | Hacker News](https://news.ycombinator.com/item?id=29624319)
[Intercept, debug & mock HTTP with HTTP Toolkit](https://httptoolkit.com/)
[HTTP Toolkit](https://httptoolkit.tech/)

[GitHub - dstotijn/hetty: An HTTP toolkit for security research.](https://github.com/dstotijn/hetty)
[Hetty | Hetty](https://hetty.xyz/)

[HTTPNetworkSniffer - http sniffer utility](https://www.nirsoft.net/utils/http_network_sniffer.html)

## HTTP live streaming - js tools
...
## HTTP servers and frameworks - 11 tools
...
## instant messengers - clients tools
...
## instantmessengers - e2e - 21 tools
...
## instantmessengers - IRC and XDCC bouncer tools

[ZNC](https://github.com/znc/znc)
An advanced IRC bouncer.

## instantmessengers - IRC and XDCC bridge tools
...
## instantmessengers - IRC and XDCC channels tools

[IRC Channel - HackerspaceWiki](https://wiki.hackerspaces.org/IRC_Channel)
hackerspace IRC channels.

## instantmessengers - IRC and XDCC clients - 16 tools
...
## instantmessengers - IRC and XDCC notifications tools
...
## instantmessengers - Matrix protocol - 13 tools
...
## instantmessengers - python tools
...
## instantmessengers - SIP messengers tools
...
## instantmessengers - sms and temporary phone numbers - 68 tools
...
## instantmessengers - sms backup tools
...
## instantmessengers - sms messenger app tools
...
## instantmessengers - video - 24 tools
...
[Apache OpenMeetings Project - Home](https://openmeetings.apache.org/)

[Meeting :: WebBrowserTools](https://webbrowsertools.com/meeting)

## instantmessengers - XMPP clients tools
...
[Dns Checker IPv6 Ping](https://dnschecker.org/ping-ipv6.php)

[IPVoid Ping IPv6](https://www.ipvoid.com/ipv6-ping-test/)

[Check-Host](https://check-host.net/check-ping)

[Online Ping IP Address - Ping tool for IPv4](https://dnschecker.org/ping-ipv4.php)

[Ping IP Online, Ping Online Tool | IPVoid](https://www.ipvoid.com/ping/)

[IP Address Lookup - Instantly Locate Your Public IP](https://dnschecker.org/ip-location.php)

[Simple Ping Blocker for Firefox - gHacks Tech News](https://www.ghacks.net/2019/05/10/simple-ping-blocker-for-firefox/)

[Ping.eu](https://ping.eu/)
online Ping, Traceroute, DNS lookup, WHOIS and others.

[Ping/telnet/dig/traceroute/whois/netstat - SecTools Top Network Security Tools](https://sectools.org/tool/os-tools)

[WinMTR download | SourceForge.net](https://sourceforge.net/projects/winmtr)
...
## ISP block test tools

[Are you being blocked?](https://www.blocked.org.uk/)
UK ISP Site Blocking Test

## jakarta ee platform tools
...
[GitHub - antoniomika/sish: HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH.](https://github.com/antoniomika/sish)

[Bore: A simple CLI tool for making tunnels to localhost | Hacker News](https://news.ycombinator.com/item?id=30970720)
[ekzhang/bore: 🕳 bore is a simple CLI tool for making tunnels to localhost](https://github.com/ekzhang/bore)

## phones - call blocker tools
...
## phones - temporary phone number tools
...
## streaming - kodi plugins - 14 tools
...
## streaming - plex - transcoding tools
...
## streaming - video streaming tools
...
## urls - open multiple links tools
...
## urls - password-protect - 11 tools
...
## urls - shorteners tools

[ShortenMyURL](https://github.com/ritwiktakkar/shorten_my_URL)
Elegant URL shortener

[GitHub - FileLeech/ServicesList: List of Services (File Sharing, URL shorteners...)](https://github.com/FileLeech/ServicesList)

[URLDev](https://url.dev/)

[Welcome to Multy! 👋](https://multy.me/)

[Linkify](https://creator.linkify.cz/)

[YOURLS | YOURLS](https://yourls.org/)
[YOURLS/awesome: A curated list of awesome things related to YOURLS](https://github.com/YOURLS/awesome)

[GitHub - connyduck/donotlink: An anonymous URL-shortener that blocks bots and removes referers](https://github.com/connyduck/donotlink)

[LinkGenerate.com](https://linkgenerate.com/)

## urls - unshorteners tools
...
## web dev - responsive design - size changes tools
...
## web frameworks - lazy load tools
...
[Remix web framework aquired by Shopify | Hacker News](https://news.ycombinator.com/item?id=33405997)
[Remixing Shopify | Remix](https://remix.run/blog/remixing-shopify)

[sansyrox/robyn: A High-Performance, Community-Driven, and Innovator Friendly Web Framework with a Rust runtime.](https://github.com/sansyrox/robyn)

[Browserify](https://browserify.org/)
[GitHub - browserify/browserify: browser-side require() the node.js way](https://github.com/browserify/browserify)
[GitHub - browserify/awesome-browserify: A curated list of awesome Browserify resources, libraries, and tools.](https://github.com/browserify/awesome-browserify)
...
[Pocketbase: Open-source back end in one file | Hacker News](https://news.ycombinator.com/item?id=38898934)
...
## webhooks and API requests - 14 tools
...
[Webhook.site - Test, transform and automate Web requests and emails](https://webhook.site/#!/view/e2377d4e-b98b-4238-aa95-e78f3d752339)
Webhook Tool
...
[PostBin: Test Your API Clients or Webhooks](https://www.postb.in/)
...
[The Collaborative API Development Platform - Insomnia](https://insomnia.rest/features/api-mocking?from=mockbin)

[GitHub - juliencrn/usehooks-ts: React hook library, ready to use, written in Typescript.](https://github.com/juliencrn/usehooks-ts)

[GitHub - vercel/swr: React Hooks for Data Fetching](https://github.com/vercel/swr)

[GitHub - hyperoracle/awesome-uniswap-hooks: A curated list of awesome Uniswap v4 hooks resources.](https://github.com/hyperoracle/awesome-uniswap-hooks)
[Uniswap v4 Hooks Directory](https://uniswaphooks.com/)

## webhooks - IFTTT - 11 tools
...
## web hosting servers - 51 tools

[Hosting - DATACLUB - Dedicated and Virtual servers](https://www.dataclub.eu/)

[VPS Austria, Virtual Server in Vienna Interxion buy VPS directly from EDIS Global. TOP VPS RDP virtual servers in Vienna for web applications, game servers, Forex and Crypto trading bots, proxy servers, VPN and other business software. Geolocated and with automated installation routines.](https://www.edisglobal.com/vps-server/austria-vienna-interxion)

[Bulletproof VPS - Bulletproof Dedicated Server - DMCA Ignored VPS](https://www.unitvps.com/)

[Cloud Infrastructure for your business | ENAHOST](https://www.enahost.com/)

[Dedicated Server Hosting Services in Europe, Asia and Americas | EstNOC](https://www.estnoc.ee/dedicated-servers.html)

[Exoscale Cloud Hosting - datacenters in Germany, Austria, Bulgaria & Switzerland](https://www.exoscale.com/)
[How Exoscale handles copyright takedown requests | Data security](https://www.exoscale.com/syslog/copyright/)

[FluidStack: Leading GPU Cloud for AI & LLM Training](https://www.fluidstack.io/)

[Free and Premium Hosting Services Xsltel OÜ](https://www.xsl.tel/)

[Business-Class FREE web hosting at .Biz.nf](https://www.biz.nf/)

[Web Hosting Pakistan - Pakistan Domain Hosting | Hostbreak](https://hostbreak.com/)
...
[IT solutions | Dedicated servers, Domain, VDS, Hosting | Weservit](https://www.weservit.nl/en/)

[About weho.st | wehost](https://weho.st/)
- THIS MAY BE GREAT FOR ME AS A BUSINESS MODEL

[Low-cost Dedicated Servers - Servers at an unbeatable price](https://www.soyoustart.com/us/essential-servers/)

[VPS Benchmarks Rankings for Linux based web servers](https://serverscope.io/)

[Dashboard | VScale](https://vscale.io/)

[United States - Private Business Cloud Hosting, Domain Name Registration and Business eMail Hosting Service Provider - ISP](https://www.nyberway.com/us/)

[DMZHOST, OFFSHORE VPS, WEBHOSTING & DEDICATED SERVER](https://dmzhost.co/)

[10Gbps Unmetered Dedicated Servers | DataPacket.com](https://www.datapacket.com/)

[BladeServers](https://bladeservers.eu/)

[Cherry Servers Bare Metal Cloud Services - Raw & Simple](https://www.cherryservers.com/)

[Offshore VPS - Offshore Dedicated Servers - Bulletproof VPS](https://www.clientvps.com/)

[Swiss-Based Cloud Servers - For Developers Who Care](https://www.cloudscale.ch/en/)

[Dedicated Server Hosting Providers | Web hosting | Dataplugs](https://www.dataplugs.com/en/)

[ISL - Your trusted cloud and web hosting partner](https://www.hkisl.net/index.php?language=english)

[Hosting Discussion](https://hostingdiscussion.com/)

[Secure Offshore Hosting | Cryptocurrencies accepted | We protect Privacy](https://www.internoc24.host/)

[Hosting Provider PQ.Hosting - Hosting provider services - Hosting company PQ.Hosting Lower price](https://pq.hosting/en/)

[OFFSHORE | DMCA IGNORED HOSTING | DDoS PROTECTED Bitcoin accepted](https://theonionhost.com/)

[Uncensored Hosting Reviews - UncensoredHosting.com](https://uncensoredhosting.com/)
...
## web hosting servers - ads tools

[Plugserv](https://www.plugserv.com/)

## web hosting servers - app-based tools

[Open-Source Application Development](https://add0n.com)

[Tau: Open-source PaaS – A self-hosted Vercel / Netlify / Cloudflare alternative | Hacker News](https://news.ycombinator.com/item?id=40946033)
[GitHub - taubyte/tau: Open source distributed Platform as a Service (PaaS). A self-hosted Vercel / Netlify / Cloudflare alternative.](https://github.com/taubyte/tau)
...
## web hosting servers - bare metal tools

[Appsmith | Open-Source Internal Tool Builder](https://www.appsmith.com/)

## web hosting servers - cloud api gateway tools
...
## web hosting servers - cloud computing tools
...
## web hosting servers - cloud seedboxes - 13 tools
...
## web hosting servers - code-focused tools
...
## web hosting servers - design-focused tools

[SMODE - Real-time visual creativity](https://www.smode.io/en/)

## web hosting servers - documents tools
...
## web hosting servers - file-focused - 26 tools

[LetsUpload](https://letsupload.io/)
...
[FileUp](https://fileup.pro/)

[CatBox](https://catbox.moe/)
[catbox](https://web.archive.org/web/20210102182957/https://catbox.moe/)
file upload site. max 200MB

[Femto](https://femto.pw/)

[Pomf](https://pomf.lain.la/)
[GitHub - tsudoko/long-live-pomf: Pomf.se alternatives](https://github.com/tsudoko/long-live-pomf)
[long-live-pomf/long-live-pomf.md at master · tsudoko/long-live-pomf · GitHub](https://github.com/tsudoko/long-live-pomf/blob/master/long-live-pomf.md)
...
[UpToCloud](https://uptocloud.co/)

[AlfaFile](https://alfafile.net/)

[Upload Files MegaUp](https://megaup.net/)

[zX3no/Awesome-File-Hosting: A curated list of file hosting websites.](https://github.com/zX3no/Awesome-File-Hosting)

[CyberDrop - An Uncensored Filehosting Service](https://cyberdrop.me/)

[GitHub - nokonoko/Uguu: Uguu is a simple lightweight temporary file host with support for drop, paste, click and API uploading.](https://github.com/nokonoko/uguu)
[Uguu · Temporary file hosting](https://uguu.se/)

[Nord Locker](https://nordlocker.com/)
Store and share your files securely, 5 GB are free.

[Peony: the best way to share files.](https://peony.ink/)

[Upload Files - VeeoSync](https://veeosync.com/)

## web hosting servers - file-focused - file sending tools
...
## web hosting servers - file-focused - file sharing - 28 tools
...
## web hosting servers - game-focused tools
...
## web hosting servers - gpu rental tools
...
[Mkdocs Obsidian](https://obsidian-publisher.netlify.app/)
...
## web hosting servers - photo-focused - 30 tools

[Picc](https://picc.io/)

[IMGE](https://im.ge/)

[Clouds](https://clouds.tf/)
...
[PicsSQL](https://pics.sql.gg/)

[IMGShare](https://imgshare.io/)

[SnipBoard](https://snipboard.io/)

[PicInfinity](https://pic8.co/)

[ImageServer](https://imageserver.link/)

[vgy.me - Simple Image Hosting](https://vgy.me/)

[Fotki: Share and Print Your Photos | Fotki.com, photo and video sharing made easy.](https://www.fotki.com/us/en/)
...
[weserv/images: Source code of wsrv.nl (formerly images.weserv.nl), to be used on your own server(s).](https://github.com/weserv/images)

[Fast, Free Image Hosting - ImageBam](https://www.imagebam.com/)

[Show HN: Horizon – Private alternative to Imgur | Hacker News](https://news.ycombinator.com/item?id=40972122)
...
[Hébergeur d'image - Hébergement d'image et upload de photo](https://www.zupimages.net/)
...
[GitHub - evgeniyd/Giraffe: iOS client for Giphy (http://giphy.com) written in Swift with ReactiveCocoa](https://github.com/evgeniyd/Giraffe)

[Unsee: 🙈 Share images securely](https://unsee.cc/)

[sxcu.net » free ShareX uploader service](https://sxcu.net/)

[Home | Slowpoke Pics](https://slow.pics/)

[ImgSpice - Free Image Hosting, Image Sharing & Earn Money](https://imgspice.com/)

[ImageSharing - Your Image Sharing Site](https://www.imagesharing.com/)

[BakaSHOTS](https://bakashots.me/)

[Photobucket | Photo Storage](https://photobucket.com/)

[Best Funny Gifs And Animated Gifs Updated Daily - Gifbin](https://gifbin.com/)

[Tenor GIF Keyboard - Bring Personality To Your Conversations](https://tenor.com/)

## web hosting servers - podcast-focused tools
...
[Stabl Podcasts](https://www.wearestabl.com/)

[Free Podcast Hosting & Podcast Websites | No Editing Skills Needed](https://soundbran.ch/)
Podcasts, Voice Messages

## web hosting servers - privacy-focused tools

[Trilightzone – Your Offshore Privacy Provider Since 2005 !](https://www.trilightzone.org/)

## web hosting servers - self-hosting - photo gallery tools
...
[Ente: Open-Source, E2E Encrypted, Google Photos Alternative | Hacker News](https://news.ycombinator.com/item?id=39570692)
[Ente - Private cloud for your photos, videos and more](https://ente.io/)

[Show HN: Memories - FOSS Google Photos alternative built for high performance | Hacker News](https://news.ycombinator.com/item?id=39783223)
...
[LibrePhotos/librephotos: A self-hosted open source photo management service. This is the repository of the backend.](https://github.com/LibrePhotos/librephotos)

[Photoprism - open-source Google Photos Alternative | Hacker News](https://news.ycombinator.com/item?id=34716924)
[PhotoPrism: AI-powered photos app for the decentralized web | Hacker News](https://news.ycombinator.com/item?id=36679368)
...
## web hosting servers - self-hosting - rclone - 15 tools
...
## web hosting servers - simple tools

[Show HN: Nekoweb - a retro static web hosting | Hacker News](https://news.ycombinator.com/item?id=39504715)
[nekoweb](https://nekoweb.org/)

[Rolls - Bublup](https://rolls.bublup.com/)

[Write.as Pro](https://write.as/pro)

[Plume: a federated blogging application](https://joinplu.me/)

## web hosting servers - simple - plaintext - 22 tools
...
[Create a new item](https://dpaste.com/)

[Friendpaste - Welcome](https://friendpaste.com/)

[Hastebin](https://www.toptal.com/developers/hastebin)

[IVPaste: Generador de Paste - Nuevo Paste](https://ivpaste.com/)

[Explore snippets · GitLab](https://invent.kde.org/explore/snippets)

[pastebin](https://p.ip.fi/)

[The fastest & easiest HTML/TEXT hosting platfrom | 2024](https://pastehtml.com/)

[Pastelink.net - Publish Hyperlinks](https://pastelink.net/)

[Paste.ee](https://paste.ee/)

[Paste code - paste.org](https://www.paste.org/p/home)

[paste.org.ru](http://paste.org.ru/)

[Paste2.org - New Paste](https://paste2.org/)

[pastebin - outil de debug collaboratif](https://pastebin.fr/)
...
[Pastebin Service](https://paste.centos.org/)

## web hosting servers - temporary tools
...
## web hosting servers - torrent tools

[Client Area](https://tup4u.com/)

## web hosting servers - video-based - 13 tools

[Teyuto | OTT, Live Streaming, VOD Streaming, Video Monetization Platform](https://teyuto.com/)

[DoodStream](https://doodstream.com/)

[ProtonVideo](https://protonvideo.to/)

[Saruch](https://saruch.co/)

[VidCloud - Videos sharing has never been easier](https://vidcloud.co/)
...
[Videy - free and simple video hosting](https://videy.co/)

[Video Hosting and Live Streaming for Business | SproutVideo](https://sproutvideo.com/)

[Free Video Hosting | Abyss.to](https://abyss.to/)

[Kwik: Just Another Video Hosting Service](https://kwik.si/)

## web hosting servers - vps - 21 tools
...
## web hosting servers - web3 tools

[Flux](https://www.runonflux.io/)
Decentralized Cloud Infrastructure

## web hosting servers - WordPress-focused tools
...
## web server software - backend - nodejs tools

[Parse Platform](https://parseplatform.org)

## web server software - cloud tools

[solid-nextcloud | Solid Nextcloud](https://pdsinterop.org/solid-nextcloud)

## web server software - cloud seedboxes tools
...
## web server software - java tools
...
## web server software - lazy load tools
...
## web server software - load testing tools
...
## web server software - machine learning tools
...
## web server software - music collaboration - js tools
...
## web server software - netflow configuration tools
...
## web server software - observability platform aka network monitor tools
...
## web server software - optimization tools
...
## web server software - search engine - 13 tools
...
## web server software - search engine - Amazon_Elasticsearch tools
...
## web server software - search engine - Amazon_OpenSearch tools
...
[Getting started - OpenSearch Documentation](https://opensearch.org/docs/latest/about/)
...
## web server software - search engine - decentralized tools

[IPSE-TEAM Overview](https://github.com/IPSE-TEAM)

[NLnet; Practical Decentralised Search and Discovery](https://nlnet.nl/project/MeshSearch/)

[Meta-Press.es](https://www.meta-press.es/)

[NLnet; Mynij](https://nlnet.nl/project/Mynij)

[Search and displace](https://searchanddisplace.com/)

## web server software - search engine library tools
...
## web server software - server applications tools
...
## web server software - server manager tools

[CapRover · Free and Open Source PaaS!](https://caprover.com/)

[libreserver](https://libreserver.org/)

## web server software - streaming and media - 15 tools
...
## web server software - torrent sites tools
...
## web server software - web application clustering tools

[AUTOM8N - cPanel-active-active redundancy, high availability](https://www.autom8n.com/)

## web server software - web bundler tools
...
## website - debugging browser tools
...
## website - directory search tools
...
## website - metadata and tags tools
...
## website - page information tools
...
## website - scrapers and archivers - Apple Music tools
...
## website - scrapers and archivers - blockchain tools

[Eternal - Archive anything](https://eternal.report/)

## website - scrapers and archivers - cli aria2 tools
...
## website - scrapers and archivers - cli tools
...
[demiurge — demiurge 0.2 documentation](https://demiurge.readthedocs.io/en/v0.2/)
...
## website - scrapers and archivers - websites - WARC files tools
...
## website - site stack and technologies - 12 tools
...
## website - speed and performance tests tools
...
## website - uptime and server monitoring tools

[SiteUptime - Website and Server Monitoring Service](https://www.siteuptime.com/users/quickcheck.php)

## website validation tools

[W3C Log Validator](https://www.w3.org/QA/Tools/LogValidator)

[Unicorn](https://validator.w3.org/unicorn)

[W3C RDF Validation Service](https://www.w3.org/RDF/Validator)

[Using XML Schemas](https://xerces.apache.org/xerces2-j/faq-xs.html)

[W3C](https://w3c.github.io/developers/tools/)
Various website validation tools

## website - web crawlers tools

[GitHub - internetarchive/brozzler: brozzler - distributed browser-based web crawler](https://github.com/internetarchive/brozzler)

[CrowLeer, the fast and flexible CLI web crawler with focus on pages download | CrowLeer](https://erap320.github.io/CrowLeer/)
...
[Url search.commoncrawl CSE](http://urlsearch.commoncrawl.org/?q=www.google.com&start=2840)
...
## website - web crawlers - open directory indexer tools
...
## website - webpage monitor - 24 tools
...
## website - webpage monitor - cookie compliance tools

[Free (Cookie) Compliance Monitor | Datastreams](https://www.datastreams.io/compliance-monitor)

## website - webpage monitor - machine learning tools
