...
[mfcar/TextTools: Tools for your text](https://github.com/mfcar/TextTools)

[Online Text Transformer](https://www.beautifyconverter.com/text-transform.php)
...
[HandyText Tool on the Mac App Store](https://apps.apple.com/us/app/handytext-tool/id1596294097?mt=12)

[Manipulist on the Mac App Store](https://apps.apple.com/gb/app/manipulist/id1577983405)

## UNSORTED - TEXT CONVERTER AND CLEANER - CASE
...
## UNSORTED - TEXT CONVERTER AND CLEANER - FILE CONVERTERS

[Dans Tools](https://www.danstools.com/)

[Word2HTML](https://word2cleanhtml.com/)
HTML Convert

[convert web pages to Kindle (mobi), ePub, and PDF files. :: Txtpaper](https://txtpaper.com/)

[GitHub - danburzo/percollate: A command-line tool to turn web pages into readable PDF, EPUB, HTML, or Markdown docs.](https://github.com/danburzo/percollate)
Format Pages for PDF/EPub/HTML
[Percollate · Dan Cătălin Burzo](https://danburzo.ro/projects/percollate/)

## UNSORTED - TEXT CONVERTER AND CLEANER - PYTHON

[Texthero · Text preprocessing, representation and visualization from zero to hero.](https://texthero.org)

## UNSORTED - TEXT FILE MANAGEMENT

[Laurence Anthony's AntFileConverter](https://laurenceanthony.net/software/antfileconverter)

[Laurence Anthony's AntFileSplitter](https://laurenceanthony.net/software/antfilesplitter)

[Laurence Anthony's AntMover](https://laurenceanthony.net/software/antmover)

[Laurence Anthony's ProtAnt](https://laurenceanthony.net/software/protant)

[Uvacoder/aaa-tools-collect6-js](https://github.com/Uvacoder/aaa-tools-collect6-js)
[React App](https://mini-dev-tools-six.vercel.app/case-converter)

[queryverse/TextParse.jl: A bunch of fast text parsing tools](https://github.com/queryverse/TextParse.jl)

[GitHub - kitesi/scoped-sort: A fetaure rich text sorter that takes indentation into account. Available on vscode, npm, the cli and a website.](https://github.com/kitesi/scoped-sort)

## UNSORTED - TEXT FILE MANAGEMENT - DRM
...
[DeDRM_tools/FAQs.md at master · apprenticeharper/DeDRM_tools](https://github.com/apprenticeharper/DeDRM_tools/blob/master/FAQs.md#so-how-can-i-remove-drm-from-my-ebooks)
[GitHub noDRM/DeDRM_tools: DeDRM tools for ebooks](https://github.com/nodrm/dedrm_tools)
DeDRM tools for ebooks.

## UNSORTED - TEXT FILE MANAGEMENT - LIBRARY MANAGEMENT

[LibraryThing](https://www.librarything.com/)
a home for your books, to manage your library and discover new books.
Recommendations are numerous and usually relevant to me for every book I tried
:star:

## UNSORTED - TEXT PARSING

[GNU roff (groff) - a GNU project🆓](https://www.gnu.org/software/groff)

[Trueprint - GNU Project - Free Software Foundation (FSF)🆓](https://www.gnu.org/software/trueprint)
...
## UNSORTED - TEXT READER

[Reclaiming the web with a personal reader | Hacker News](https://news.ycombinator.com/item?id=38622404)
[Reclaiming the Web with a Personal Reader | olano.dev](https://olano.dev/blog/reclaiming-the-web-with-a-personal-reader)

[Zeal Offline Documentation Browser](https://zealdocs.org/)

[Ebook Reader for web](https://www.loudreader.com/)

## UNSORTED - TEXT READING ESTIMATION

[X Minutes to Read](https://xminutestoread.xyz/)

## UNSORTED - TEXT REVERSE
...
## UNSORTED - TEXT TABLES

[Plain Text Table](https://plaintexttools.github.io/plain-text-table/)
Text Tables

## UNSORTED - TEXT TO HANDWRITING

[Text to Handwriting](https://saurabhdaware.github.io/text-to-handwriting/)
Text to Handwriting Converter

[HandWrittner](https://handwrittner.com/?lang=en)
Text to Handwriting Converter

## UNSORTED - TEXT TO IMAGE

[Polona Typo](http://typo.polona.pl/en/)
Create Text out of Book, Poster & Map Letters

[The Death Generator](https://deathgenerator.com/)
Video Game Text Generator

[Pixel Speech Bubble](https://pixelspeechbubble.com/)
Create Pixel Speech Bubbles

## UNSORTED - TEXT-TO-TEXT - CHATBOTS - CONFLICTS

[CICERO: An AI agent that negotiates, persuades, and cooperates with people | Hacker News](https://news.ycombinator.com/item?id=33706750)
[CICERO: An AI agent that negotiates, persuades, and cooperates with people](https://ai.meta.com/blog/cicero-ai-negotiates-persuades-and-cooperates-with-people/)
...
## UNSORTED - UNICODE AND SYMBOLS

[Symbols.com](https://www.symbols.com/)
[What does this symbol mean?](https://www.symbols.com/what-is-this-symbol.php)

[GNU Teseq - GNU Project - Free Software Foundation🆓](https://www.gnu.org/software/teseq)

[GitHub - emvi/iso-639-1: List of ISO 639-1 languages and codes.](https://github.com/emvi/iso-639-1)

[GitHub - atrinh0/sfsymbols: SwiftUI app to search and showcase SF Symbols 🔎](https://github.com/atrinh0/sfsymbols)

## UNSORTED - UNICODE AND SYMBOLS - CHARACTERS
...
[Phonetic](https://github.com/iAugux/Phonetic)
Add phonetic keys for Chinese names

[Box-drawing character](https://en.wikipedia.org/wiki/Box-drawing_character)
because using some characters such as ╭	╮	╯╰> is useful especially for arrows : ╰>

[Help! Is This Arabic? | Hacker News](https://news.ycombinator.com/item?id=34949146)
[Help, is this عربي?](https://isthisarabic.com/)

[libunistring - GNU Project - Free Software Foundation (FSF)🆓](https://www.gnu.org/software/libunistring)

[I or l?](https://iorl.info/)
Is it an uppercase "i", or is it a lowercase "L"?

## UNSORTED - UNICODE AND SYMBOLS - CHARACTERS - EMOTICONS

[Donger List](http://dongerlist.com/)
600+ Unicode Emoticons
Set of unicode characters assembled to form a text emoticon.

## UNSORTED - REFERENCE AND CHEATSHEETS - ABBREVIATIONS
...
## UNSORTED - REFERENCE AND CHEATSHEETS - MARKDOWN
...
[GitHub - mundimark/quickrefs: Markdown 'n' Friends Quick References (Cheat Sheets)](https://github.com/mundimark/quickrefs)

[markupmadness.github.io](https://markupmadness.github.io/)

[Markdown Lint Rules/Style Checker](http://updownpress.github.io/markdown-lint)
[Text in Manuscripts](https://github.com/updownpress/markdown-lint)
by Mark Harrison

[ty-/spec-style-guide](https://github.com/ty-/spec-style-guide)
some best practices for writing markdown based specifications to be printable by gitprint.com and pandoc

[Adam Pritchard/markdown-here](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
Markdown Cheatsheet

[Wiki Creole](http://www.wikicreole.org/)
[Creole 1.0](http://www.wikicreole.org/wiki/Creole1.0)

[GitHub - linuxlawson/gitmark: Frequently used GitHub Markdown](https://github.com/linuxlawson/gitmark)

[GitHub - bgoonz/Markdown-Templates](https://github.com/bgoonz/Markdown-Templates)

[conway-markdown/conway-markdown.github.io: GitHub pages documentation for Conway-Markdown (CMD).](https://github.com/conway-markdown/conway-markdown.github.io)

[Markdown Snippets](https://github.com/markdown-templates/markdown-snippets)

[Markdown Configuration (.mdconf)](https://github.com/tj/mdconf)
by TJ Holowaychuk et al

[Markdown Can I Use ___ ? - kramdown, GitHub-Flavored Markdown (GFM), CommonMark, Pandoc, etc.](https://mundimark.github.io/markdown-can-i-use/)
Tables, Footnotes, Inline Notes, Citations, Task Lists, etc.

[Markdown Live](https://markdown-live.netlify.app/)

## UNSORTED - REFERENCE AND CHEATSHEETS - README FILE

[Cheatsheet-lang/Git-markdown: Make your README more creative with this cheatsheet](https://github.com/Cheatsheet-lang/Git-markdown)

## UNSORTED - REFERENCE AND CHEATSHEETS - TECHNICAL DOCUMENTATION

[GitHub - matheusfelipeog/beautiful-docs: Pointers to useful, well-written, and otherwise beautiful documentation.](https://github.com/matheusfelipeog/beautiful-docs)

[Show HN: A set of standard document templates | Hacker News](https://news.ycombinator.com/item?id=22091603)
[GitHub - kbariotis/templates: A set of standard document templates.](https://github.com/kbariotis/templates)

## UNSORTED - REFERENCE AND CHEATSHEETS - UNICODE CHARACTERS

[numbas/unicode-math-normalization: Data for normalizing mathematical expressions written in Unicode](https://github.com/numbas/unicode-math-normalization)

[URL Encoded Characters](http://www.degraeve.com/reference/urlencoding.php)
mapping table of encoded characters in URLS (%20, %22, %7D, ...)
